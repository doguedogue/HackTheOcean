				...
				<ul className='Developers'>
					<li>
						<a href='https://github.com/lukitachan' rel='noreferrer' target='_blank'>
							<img src='https://avatars.githubusercontent.com/u/101657514?v=4' class='circle' alt='@lukitachan' />
							&nbsp; Lucy &nbsp; @lukitachan
						</a>
					</li>
					<li>
						<a href='https://github.com/chistoperez' rel='noreferrer' target='_blank'>
							<img src='https://avatars.githubusercontent.com/u/99354481?v=4' class='circle' alt='@chistoperez' />
							&nbsp; Christopher &nbsp; @chistoperez
						</a>
					</li>
					<li>
						<a href='https://github.com/dfredude' rel='noreferrer' target='_blank'>
							<img src='https://avatars.githubusercontent.com/u/72330887?v=4' class='circle' alt='@dfredude' />
							&nbsp; Alfred &nbsp; @dfredude
						</a>
					</li>
					<li>
